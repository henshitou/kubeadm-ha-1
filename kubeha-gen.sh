...
kubectl apply -f /icds/dev/kubeadm-ha/ha-othersolution/kubeadm-ha-1/manl-yaml/1.13.0/plugin/traefik.yaml
kubectl apply -f /icds/dev/kubeadm-ha/ha-othersolution/kubeadm-ha-1/manl-yaml/1.13.0/plugin/metrics.yaml
kubectl apply -f /icds/dev/kubeadm-ha/ha-othersolution/kubeadm-ha-1/manl-yaml/1.13.0/plugin/kubernetes-dashboard.yaml
